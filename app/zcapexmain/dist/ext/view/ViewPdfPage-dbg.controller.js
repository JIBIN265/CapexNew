sap.ui.define(
    ...
    function (PageController) {
        ...
        return PageController.extend('zcapexmain.ext.view.ViewPdfPage', {
            /**
            ...
            handleFullScreen: function (oEvent) {
                ...
                this.byId("zcapexmain::attachmentsViewPdfPagePage--enterFullScreenBtn").setVisible(false)
                this.byId("zcapexmain::attachmentsViewPdfPagePage--exitFullScreenBtn").setVisible(true)

            },

            handleExitFullScreen: function (oEvent) {
                this.editFlow.getInternalRouting().switchFullScreen()
                this.byId("zcapexmain::attachmentsViewPdfPagePage--enterFullScreenBtn").setVisible(true)
                this.byId("zcapexmain::attachmentsViewPdfPagePage--exitFullScreenBtn").setVisible(false)
            },
