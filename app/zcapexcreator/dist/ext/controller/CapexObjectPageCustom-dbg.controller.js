sap.ui.define(['sap/ui/core/mvc/ControllerExtension'], function (ControllerExtension) {
	...
	return ControllerExtension.extend('zcapexcreator.ext.controller.CapexObjectPageCustom', {
		// this section allows to extend lifecycle hooks or hooks provided by Fiori elements
		override: {
			/**
			 * Called when a controller is instantiated and its View controls (if available) are already created.
			 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
			 * @memberOf zcapexcreator.ext.controller.CapexObjectPageCustom
			 */
			onInit: function () {
			...
			routing: {
				...
				onAfterBinding: async function (oBindingContext) {
					...
					try {
						...
						// };
						// const oAttachmentTable = oExtensionAPI.byId('zcapexcreator::CapexObjectPage--fe::table::attachments::LineItem::Table')
						...
						// }
						// const oFeedListItemTemplate = oExtensionAPI.byId('zcapexcreator::CapexObjectPage--fe::CustomSubSection::Feed--feedListItemTemplate')
						// if (oList) {
			...
			// 	const oList = oExtensionAPI.byId('zcapexcreator::CapexObjectPage--fe::CustomSubSection::Feed--commentsList');
			// 	if (oList) {
